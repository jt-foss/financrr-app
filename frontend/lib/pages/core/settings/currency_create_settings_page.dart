...
class CurrencyCreateSettingsPage extends StatefulWidget {
  static const PagePathBuilder pagePath = PagePathBuilder.child(parent: CurrencySettingsPage.pagePath, path: 'create');

  const CurrencyCreateSettingsPage({super.key});

  @override
  State<StatefulWidget> createState() => _CurrencyCreateSettingsPageState();
}

class _CurrencyCreateSettingsPageState extends State<CurrencyCreateSettingsPage> {
